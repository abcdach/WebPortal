...
..[page], 1
..{ 
	..create_page,ON_CONNECTING
	..create_page,ON_CONNECTED
	..create_page,ON_DISCONNECT
	..create_page,ON_FAILURE	   
	..button, Connect,
			MQTT_HOST        = "192.168.0.107";
			MQTT_PORT        = "4004";
			MQTT_OBJECT_ID   = "114";
			MQTT_OBJECT_NAME = "DziaDzia Lova";
			MQTT_ON_CONNECTING_PAGE = "ON_CONNECTING";
			MQTT_ON_CONNECTED_PAGE  = "ON_CONNECTED";
			MQTT_ON_DISCONNECT_PAGE = "ON_DISCONNECT";
			MQTT_ON_FAILURE_PAGE    = "ON_FAILURE"
			MQTT_START();	   
..}
..[page],ON_CONNECTING
..{
...
..{
    ...
    ..input_text(it2)
    ..label,
    ..if_event, In_0, put_input_text('it2',Value);
	..##,2
	..button, 0, Out_0("0");
	..button, 1, Out_0("1");
..}
