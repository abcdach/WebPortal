...
function setup() {
	...
	P09_0 	  = new is_createImg('pic/09_0.jpg',GUI_X-15,GUI_Y +95 ,'390px','105px',isNull,1);
	...
	Server_START  = new is_createButton('CONNECT',GUI_X,GUI_Y+100, '90px', '22px', initWebSocket,1 ); 	
	...
	Server_IP	  = new is_createInput2 (localStorage.getItem('SensorStudio_IP'),GUI_X-2-10,GUI_Y-30, '110px','CENTER','#DAF7A6','ridge','12px','Arial','#ffffff','bold','italic',1);	
	...
	Wifi_Status   = new is_createInput2 ('',GUI_X,GUI_Y+78, '86px','CENTER','#DAF7A6','none','8px','Arial','#ffffff','bold','',0);
	...
	Mqtt_Status   = new is_createInput2 ('',GUI_X,GUI_Y+78, '86px','CENTER','#FFFFFF','none','8px','Arial','#ffffff','bold','',0);
